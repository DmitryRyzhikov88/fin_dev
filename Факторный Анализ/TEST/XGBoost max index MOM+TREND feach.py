...
params = pd.read_excel('PARAMS.xlsx').fillna('')[-4:-1]
                ...
                for i in range(len(income_df)):
                    ...
                    try:
                        ...
                        try:
                            ...
                            year_prof_more_index = portfolio_profit_per_year.loc[yahhh][str(int(period[-2].split('-')[0]) + 1)].where(
                                portfolio_profit_per_year.loc[yahhh][str(int(period[-2].split('-')[0]) + 1)] > index_profit)
                            year_prof_more_index_list.append(year_prof_more_index.dropna().mean())
                            # print(year_prof_more_index.dropna())

...
# -------------------------------- РАСЧЕТНЫЙ ЦИКЛ ----------------------------------------
    ...
    for i in range(years_len):
        ...
        # print('Год расчета доходности: ', start)
...
#
#     try:
#         with pd.ExcelWriter('PORTFOLIO PER YEAR/PORTFOLIO_KNN_(dynamic_feach_6)_Valuation3.0_(normal).xlsx', mode='a') as writer:
#             portfolio_df_final.to_excel(writer, sheet_name=list)
#     except:
#         with pd.ExcelWriter('PORTFOLIO PER YEAR/PORTFOLIO_KNN_(dynamic_feach_6)_Valuation3.0_(normal).xlsx', mode='w') as writer:
#             portfolio_df_final.to_excel(writer, sheet_name=list)
#
#
#     print('^' * 50)
...
#
# Returnez_finish[::-1].to_excel('ReturnS_KNN_(dynamic_feach_6)_Valuation3.0_(normal).xlsx')
#
#

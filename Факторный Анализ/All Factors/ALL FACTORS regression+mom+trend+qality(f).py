    ...
    for ticker in tickers:
        ...
        if check == 1:
            ...
            try:
                ...
                Data_for_Portfolio['Piotroski F-Score'] = valuation_and_quality_df['Piotroski F-Score']
...
# -------------------------------- РАСЧЕТНЫЙ ЦИКЛ ----------------------------------------
    ...
    for i in range(years_len):
        ...
        Data_for_Portfolio_master_filter['Quality Score'] = Data_for_Portfolio_master_filter['Piotroski F-Score']
        #
        ...
        normal_values = scaler.fit_transform(Data_for_Portfolio_master_filter[['Valuation Score', 'Quality Score']])

        Data_for_Portfolio_master_filter[['Valuation Score', 'Quality Score']] = normal_values
...
Returnez_finish[::-1].to_excel('ReturnS+mom+trend+qality(f).xlsx')

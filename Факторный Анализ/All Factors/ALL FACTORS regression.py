...
# -------------------------------- РАСЧЕТНЫЙ ЦИКЛ ----------------------------------------
    ...
    for i in range(years_len):
        ...
        #                                        'Grows score', 'Momentum Score', 'Shareholder Yield Score']])
        #
        # Data_for_Portfolio_master_filter[['Valuation Score', 'Quality Score',\
        #                                        'Grows score', 'Momentum Score', 'Shareholder Yield Score']] = normal_values

        Data_for_Portfolio_master_filter['Total Score'] = Data_for_Portfolio_master_filter['EBITDA/EV Z score']
...
Returnez_finish[::-1].to_excel('ReturnS.xlsx')
